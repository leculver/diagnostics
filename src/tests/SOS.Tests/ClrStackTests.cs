...
public sealed class ClrStackTests
{
    ...
    public static TheoryData<TestConfig> GcRootsFlagMatrix { get; } = TestMatrices.FullDumpOnCoreVersions([TargetCatalog.Scenarios], CoreVersion.Net8 | CoreVersion.Net9 | CoreVersion.Net10);
